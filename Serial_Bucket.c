...
int main(int argc, char *argv[]){
	...
	if (argc == 3){
		// First argument is the size of the list, second is the number of buckets
		num_elem = atoi(argv[1]);
		buckets = atoi(argv[2]);
	}else{
		printf("\nNo arguments given, continuing with default values: NUM_ELEMENTS 20 BUCKETS 2\n");
	}
